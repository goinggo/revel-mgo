...
import (
	...
	_ "github.com/goinggo/revel-mgo/app"
	controllers1 "github.com/goinggo/revel-mgo/app/controllers"
	controllerbase "github.com/goinggo/revel-mgo/app/controllers/base"
	tests "github.com/goinggo/revel-mgo/tests"
	...
	revel.RegisterController((*controllers1.App)(nil),
		[]*revel.MethodType{
			...
			&revel.MethodType{
				Name: "Station",
				Args: []*revel.MethodArg{ 
					&revel.MethodArg{Name: "stationId", Type: reflect.TypeOf((*string)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
				},
			},
